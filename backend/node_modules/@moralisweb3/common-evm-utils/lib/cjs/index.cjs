...
var EvmAddress = /** @class */ (function () {
    ...
    EvmAddress.create = function (address, core) {
        ...
        var finalCore = core || commonCore.CoreProvider.getDefault();
...
var EvmChain = /** @class */ (function () {
    ...
    EvmChain.create = function (chain, core) {
        ...
        var c = core || commonCore.CoreProvider.getDefault();
    ...
    EvmChain.prototype.format = function (_formatStyle) {
        ...
        return commonCore.assertUnreachable(formatStyle);
    };
    /**
...
var Erc20Token = /** @class */ (function () {
    ...
    Erc20Token.create = function (value, core) {
        ...
        var finalCore = core !== null && core !== void 0 ? core : commonCore.CoreProvider.getDefault();
...
var Erc20Approval = /** @class */ (function () {
    function Erc20Approval(data, core) {
     ...
     *```
     */
    Erc20Approval.create = function (data, core) {
    ...
    Erc20Approval.prototype.toJSON = function () {
        var data = this._data;
        return __assign(__assign({}, data), { chain: data.chain.format(), contractAddress: data.contractAddress.format(), blockNumber: data.blockNumber.toString(), toWallet: data.toWallet.format(), fromWallet: data.fromWallet.format(), value: data.value.toString() });
    };
    /**
     * @returns a JSON representation of the approval.
    ...
    Erc20Approval.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), contractAddress: EvmAddress.create(data.contractAddress, core), fromWallet: EvmAddress.create(data.fromWallet, core), toWallet: EvmAddress.create(data.toWallet, core), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), blockNumber: commonCore.BigNumber.create(data.blockNumber), value: commonCore.BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
...
var Erc20Burn = /** @class */ (function () {
     ...
     *```
     */
    Erc20Burn.create = function (data, core) {
    ...
    Erc20Burn.prototype.toJSON = function () {
        var data = this._data;
        return __assign(__assign({}, data), { chain: data.chain.format(), contractAddress: data.contractAddress.format(), blockNumber: data.blockNumber.toString(), fromWallet: data.fromWallet.format(), value: data.value.toString() });
    };
    /**
     * @returns a JSON representation of the burn.
     * @example burn.format()
    ...
    Erc20Burn.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), contractAddress: EvmAddress.create(data.contractAddress, core), fromWallet: EvmAddress.create(data.fromWallet, core), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), blockNumber: commonCore.BigNumber.create(data.blockNumber), value: commonCore.BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
    return Erc20Burn;
}());
...
var Erc20Mint = /** @class */ (function () {
     ...
     *```
     */
    Erc20Mint.create = function (data, core) {
    ...
    Erc20Mint.prototype.toJSON = function () {
        var data = this._data;
        return __assign(__assign({}, data), { chain: data.chain.format(), contractAddress: data.contractAddress.format(), blockNumber: data.blockNumber.toString(), toWallet: data.toWallet.format(), value: data.value.toString() });
    };
    /**
     * @returns a JSON representation of the mint.
     * @example mint.format()
    ...
    Erc20Mint.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), contractAddress: EvmAddress.create(data.contractAddress, core), toWallet: EvmAddress.create(data.toWallet, core), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), blockNumber: commonCore.BigNumber.create(data.blockNumber), value: commonCore.BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
    return Erc20Mint;
}());
...
var Erc20Transfer = /** @class */ (function () {
    function Erc20Transfer(data, core) {
     ...
     *```
     */
    Erc20Transfer.create = function (data, core) {
    ...
    Erc20Transfer.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), address: EvmAddress.create(data.address, core), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), blockNumber: commonCore.BigNumber.create(data.blockNumber), toAddress: EvmAddress.create(data.toAddress, core), fromAddress: EvmAddress.create(data.fromAddress, core), value: commonCore.BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
...
var EvmInternalTransaction = /** @class */ (function () {
    function EvmInternalTransaction(data, core) {
     ...
     *```
     */
    EvmInternalTransaction.create = function (data, core) {
    ...
    EvmInternalTransaction.prototype.toJSON = function () {
        ...
        var data = this._data;
        return __assign(__assign({}, data), { to: (_a = data.to) === null || _a === void 0 ? void 0 : _a.format(), from: (_b = data.from) === null || _b === void 0 ? void 0 : _b.format(), gas: (_c = data.gas) === null || _c === void 0 ? void 0 : _c.toString(), gasUsed: (_d = data.gasUsed) === null || _d === void 0 ? void 0 : _d.toString(), value: (_e = data.value) === null || _e === void 0 ? void 0 : _e.toString(), chain: (_f = data.chain) === null || _f === void 0 ? void 0 : _f.format(), blockNumber: (_g = data.blockNumber) === null || _g === void 0 ? void 0 : _g.toString() });
    };
    /**
    ...
    EvmInternalTransaction.parse = function (data, core) { return ({
...
var EvmTransaction = /** @class */ (function () {
    ...
    EvmTransaction.parse = function (data, core) {
        ...
        return {
            from: EvmAddress.create(data.from, core),
            to: commonCore.maybe(data.to, function (to) { return EvmAddress.create(to, core); }),
            ...
            gasUsed: commonCore.BigNumber.create(data.gasUsed),
            contractAddress: commonCore.maybe(data.contractAddress, function (address) { return EvmAddress.create(address, core); }),
            ...
            internalTransactions: ((_b = data.internalTransactions) !== null && _b !== void 0 ? _b : []).map(function (transaction) {
                return EvmInternalTransaction.create(transaction, core);
            }),
...
var EvmEvent = /** @class */ (function () {
    ...
    EvmEvent.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), address: EvmAddress.create(data.address, core), blockNumber: commonCore.BigNumber.create(data.blockNumber), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), data: {
            from: commonCore.maybe(data.data.from, function (from) { return EvmAddress.create(from, core); }),
            to: commonCore.maybe(data.data.to, function (to) { return EvmAddress.create(to, core); }),
...
var EvmNftMedia = /** @class */ (function () {
    function EvmNftMedia(data, core) {
     ...
     *```
     */
    EvmNftMedia.create = function (data, core) {
    ...
    EvmNftMedia.prototype.toJSON = function () {
        var data = this._data;
        return __assign(__assign({}, data), { chain: data.chain.format() });
    };
    /**
     * @returns a JSON representation of the media.
    ...
    EvmNftMedia.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), updatedAt: commonCore.maybe(data.updatedAt, function (date) { return commonCore.dateInputToDate(date); }) })); };
    return EvmNftMedia;
}());
...
var EvmNft = /** @class */ (function () {
    ...
    EvmNft.prototype.toJSON = function () {
        var _b, _c, _d, _e;
        var data = this._data;
        return __assign(__assign({}, data), { tokenAddress: data.tokenAddress.format(), chain: data.chain.format(), ownerOf: (_b = data.ownerOf) === null || _b === void 0 ? void 0 : _b.format(), blockNumberMinted: (_c = data.blockNumberMinted) === null || _c === void 0 ? void 0 : _c.toString(), blockNumber: (_d = data.blockNumber) === null || _d === void 0 ? void 0 : _d.toString(), media: (_e = data.media) === null || _e === void 0 ? void 0 : _e.format() });
    };
    /**
     * Converts the EvmNft instance to a JSON object.
     * @returns JSON object of the EvmNft instance
...
var EvmNftCollection = /** @class */ (function () {
    ...
    EvmNftCollection.parse = function (data, core) { return (__assign(__assign({}, data), { tokenAddress: EvmAddress.create(data.tokenAddress, core), chain: EvmChain.create(data.chain, core), contractType: commonCore.maybe(data.contractType) })); };
...
var EvmNftTrade = /** @class */ (function () {
    ...
    EvmNftTrade.parse = function (data) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain), sellerAddress: EvmAddress.create(data.sellerAddress), buyerAddress: EvmAddress.create(data.buyerAddress), marketplaceAddress: EvmAddress.create(data.marketplaceAddress), tokenAddress: EvmAddress.create(data.tokenAddress), priceTokenAddress: commonCore.maybe(data.priceTokenAddress, EvmAddress.create), blockNumber: commonCore.BigNumber.create(data.blockNumber), price: EvmNative.create(data.price), transactionIndex: +data.transactionIndex, blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp) })); };
    return EvmNftTrade;
}());
...
var EvmNftTransfer = /** @class */ (function () {
    ...
    EvmNftTransfer.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), amount: commonCore.maybe(data.amount, function (amount) { return +amount; }), blockNumber: commonCore.BigNumber.create(data.blockNumber), blockTimestamp: commonCore.dateInputToDate(data.blockTimestamp), transactionIndex: commonCore.maybe(data.transactionIndex, function (index) { return +index; }), transactionType: commonCore.maybe(data.transactionType), fromAddress: commonCore.maybe(data.fromAddress, function (address) { return EvmAddress.create(address, core); }), toAddress: EvmAddress.create(data.toAddress, core), tokenAddress: EvmAddress.create(data.tokenAddress, core), value: commonCore.maybe(data.value, EvmNative.create), operator: commonCore.maybe(data.operator, function (operator) { return EvmAddress.create(operator, core); }), logIndex: +data.logIndex })); };
...
var EvmTransactionLogDecoded = /** @class */ (function (_super) {
    ...
    function EvmTransactionLogDecoded(value, core) {
        var _this = _super.call(this, value, core) || this;
        _this._value = EvmTransactionLogDecoded.parse(value, core);
        return _this;
    }
    /**
     ...
     * @param core - The Core instance
     */
    EvmTransactionLogDecoded.create = function (value, core) {
    ...
    EvmTransactionLogDecoded.parse = function (value, core) {
        var data = _super.parse.call(this, value, core);
...
var EvmTransactionVerbose = /** @class */ (function (_super) {
    ...
    function EvmTransactionVerbose(data, core) {
        var _this = _super.call(this, data, core) || this;
        _this._data = EvmTransactionVerbose.parse(data, core);
        return _this;
    }
    /**
     ...
     *```
     */
    EvmTransactionVerbose.create = function (data, core) {
    ...
    EvmTransactionVerbose.parse = function (data, core) {
        var parsed = _super.parse.call(_a, data, core);
        return __assign(__assign({}, parsed), { logs: data.logs.map(function (log) { return EvmTransactionLogDecoded.create(log, core); }), decodedCall: data.decodedCall });
    };
...
function deserializeResponse$F(jsonResponse, request, core) {
    ...
    return (_b = ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : [])) === null || _b === void 0 ? void 0 : _b.map(function (log) {
        return EvmTransactionLog.create(__assign(__assign({}, commonCore.toCamelCase(log)), { topics: [log.topic0, log.topic1, log.topic2, log.topic3], blockNumber: Number(log.block_number), chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
...
function deserializeResponse$D(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (data) {
        ...
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: chain, ownerOf: nft.ownerOf ? EvmAddress.create(nft.ownerOf, core) : undefined, lastMetadataSync: nft.lastMetadataSync ? new Date(nft.lastMetadataSync) : undefined, lastTokenUriSync: nft.lastTokenUriSync ? new Date(nft.lastTokenUriSync) : undefined, media: commonCore.maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, commonCore.toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$C(jsonResponse, request, core) {
    return (jsonResponse !== null && jsonResponse !== void 0 ? jsonResponse : []).map(function (data) {
        ...
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = commonCore.toCamelCase(data);
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), amount: nft.amount ? parseInt(nft.amount, 10) : undefined, ownerOf: EvmAddress.create(nft.ownerOf, core), lastMetadataSync: commonCore.dateInputToDate(nft.lastMetadataSync), lastTokenUriSync: commonCore.dateInputToDate(nft.lastTokenUriSync), media: commonCore.maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, commonCore.toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$y(jsonResponse, request, core) {
    ...
    return EvmNft.create(__assign(__assign({}, nft), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: nft.ownerOf ? EvmAddress.create(nft.ownerOf, core) : undefined, lastMetadataSync: nft.lastMetadataSync ? new Date(nft.lastMetadataSync) : undefined, lastTokenUriSync: nft.lastTokenUriSync ? new Date(nft.lastTokenUriSync) : undefined, media: commonCore.maybe(nft.media, function (media) {
            return EvmNftMedia.create(__assign({ chain: chain }, commonCore.toCamelCase(media)), core);
        }) }), core);
}
...
function deserializeResponse$x(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (data) {
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = commonCore.toCamelCase(data);
        return EvmNft.create(__assign(__assign({}, nft), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.ownerOf, core), lastMetadataSync: new Date(nft.lastMetadataSync), lastTokenUriSync: new Date(nft.lastTokenUriSync), media: commonCore.maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, commonCore.toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$w(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (data) {
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = commonCore.toCamelCase(data);
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.ownerOf, core), lastMetadataSync: new Date(nft.lastMetadataSync), lastTokenUriSync: new Date(nft.lastTokenUriSync), media: commonCore.maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, commonCore.toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$v(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (trade) {
        return EvmNftTrade.create(__assign(__assign({}, commonCore.toCamelCase(trade)), { chain: EvmChainResolver.resolve(request.chain, core), sellerAddress: EvmAddress.create(trade.seller_address, core), buyerAddress: EvmAddress.create(trade.buyer_address, core), marketplaceAddress: EvmAddress.create(trade.marketplace_address, core), priceTokenAddress: commonCore.maybe(trade.price_token_address, function (address) { return EvmAddress.create(address, core); }), tokenAddress: EvmAddress.create(trade.token_address, core), price: EvmNative.create(trade.price, 'wei'), blockTimestamp: new Date(trade.block_timestamp), tokenIds: trade.token_ids }));
    });
}
...
function deserializeResponse$r(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (collection) {
        return EvmNftCollection.create(__assign(__assign({}, commonCore.toCamelCase(collection)), { chain: EvmChainResolver.resolve(request.chain, core), tokenAddress: EvmAddress.create(collection.token_address, core) }), core);
    });
}
...
function deserializeRequest$n(jsonRequest, core) {
    return {
        ...
        fromDate: jsonRequest.fromDate,
        toDate: jsonRequest.toDate,
        addresses: commonCore.maybe(jsonRequest.addresses, function (addresses) {
            return addresses.map(function (address) { return EvmAddress.create(address, core); });
        }),
        cursor: jsonRequest.cursor,
        limit: jsonRequest.limit,
...
function getRequestUrlParams$l(request, core) {
    return {
        address: commonCore.maybe(request.address, function (address) { return EvmAddress.create(address, core).checksum; }),
    };
}
...
function deserializeRequest$l(jsonRequest, core) {
    return {
        address: commonCore.maybe(jsonRequest.address, function (address) { return EvmAddress.create(address, core); }),
    };
}
...
function deserializeResponse$j(jsonResponse, _, core) {
    return {
        address: EvmAddress.create(jsonResponse.address, core),
    };
}
...
function getRequestUrlParams$i(request, core) {
    ...
    return {
        ...
        limit: commonCore.maybe(request.limit, String),
        cursor: request.cursor,
        contract_addresses: (_a = request.contractAddresses) === null || _a === void 0 ? void 0 : _a.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        exclude_contracts: (_b = request.excludeContracts) === null || _b === void 0 ? void 0 : _b.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        wallet_addresses: (_c = request.walletAddresses) === null || _c === void 0 ? void 0 : _c.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        exclude_wallets: (_d = request.excludeWallets) === null || _d === void 0 ? void 0 : _d.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
    };
}
function deserializeResponse$i(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (approval) {
        return Erc20Approval.create(__assign(__assign({}, commonCore.toCamelCase(approval)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$i(request, core) {
    var _a, _b, _c, _d;
    return {
        ...
        fromBlock: request.fromBlock,
        toBlock: request.toBlock,
        contractAddresses: (_a = request.contractAddresses) === null || _a === void 0 ? void 0 : _a.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        excludeContracts: (_b = request.excludeContracts) === null || _b === void 0 ? void 0 : _b.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        walletAddresses: (_c = request.walletAddresses) === null || _c === void 0 ? void 0 : _c.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
        excludeWallets: (_d = request.excludeWallets) === null || _d === void 0 ? void 0 : _d.map(function (address) { return EvmAddress.create(address, core).lowercase; }),
    };
}
function deserializeRequest$i(jsonRequest, core) {
    var _a, _b, _c, _d;
    return {
        ...
        fromBlock: jsonRequest.fromBlock,
        toBlock: jsonRequest.toBlock,
        contractAddresses: (_a = jsonRequest.contractAddresses) === null || _a === void 0 ? void 0 : _a.map(function (address) { return EvmAddress.create(address, core); }),
        excludeContracts: (_b = jsonRequest.excludeContracts) === null || _b === void 0 ? void 0 : _b.map(function (address) { return EvmAddress.create(address, core); }),
        walletAddresses: (_c = jsonRequest.walletAddresses) === null || _c === void 0 ? void 0 : _c.map(function (address) { return EvmAddress.create(address, core); }),
        excludeWallets: (_d = jsonRequest.excludeWallets) === null || _d === void 0 ? void 0 : _d.map(function (address) { return EvmAddress.create(address, core); }),
    };
}
...
function deserializeResponse$h(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (burn) {
        return Erc20Burn.create(__assign(__assign({}, commonCore.toCamelCase(burn)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$h(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$g(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (transfer) {
        return Erc20Transfer.create(__assign(__assign({}, commonCore.toCamelCase(transfer)), { chain: EvmChainResolver.resolve(request.chain, core), address: EvmAddress.create(transfer.contract_address, core), toAddress: EvmAddress.create(transfer.to_wallet, core), fromAddress: EvmAddress.create(transfer.from_wallet, core) }), core);
    });
}
function serializeRequest$g(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$f(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (mint) {
        return Erc20Mint.create(__assign(__assign({}, commonCore.toCamelCase(mint)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$f(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$d(jsonResponse, request, core) {
    return (jsonResponse !== null && jsonResponse !== void 0 ? jsonResponse : []).map(function (token) {
        return {
            token: Erc20Token.create(__assign(__assign({}, commonCore.toCamelCase(token)), { contractAddress: token.address, chain: EvmChainResolver.resolve(request.chain, core) }), core),
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (transfer) {
        ...
        return EvmTransaction.create({
            ...
            internalTransactions: ((_a = transfer.internal_transactions) !== null && _a !== void 0 ? _a : []).map(function (jsonInternalTransaction) {
                var internalTransaction = commonCore.toCamelCase(jsonInternalTransaction);
                return EvmInternalTransaction.create(__assign({ chain: chain }, internalTransaction), core);
            }),
        }, core);
    });
}
