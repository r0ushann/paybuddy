...
import _moralisweb3_common_core__default, { MoralisData, Core, Config, EvmAddressFormat, EvmChainable, EvmChainIdFormat, MoralisDataObject, BigNumberish, DateInput, BigNumber, MoralisDataObjectValue, Module, Camelize, ResponseAdapter, Operation, PaginatedResponseAdapter, PaginatedOperation, ConfigKey } from '@moralisweb3/common-core';
...
declare class Erc20Approval implements MoralisDataObject {
     ...
     *```
     */
    static create(data: Erc20Approval | Erc20ApprovalInput, core?: _moralisweb3_common_core__default): Erc20Approval;
    private _data;
    constructor(data: Erc20ApprovalInput, core: _moralisweb3_common_core__default);
    static parse: (data: Erc20ApprovalInput, core: _moralisweb3_common_core__default) => Erc20ApprovalData;
    /**
...
declare class Erc20Burn implements MoralisDataObject {
     ...
     *```
     */
    static create(data: Erc20Burn | Erc20BurnInput, core?: _moralisweb3_common_core__default): Erc20Burn;
    private _data;
    constructor(data: Erc20BurnInput, core: _moralisweb3_common_core__default);
    static parse: (data: Erc20BurnInput, core: _moralisweb3_common_core__default) => Erc20BurnData;
    /**
...
declare class Erc20Mint implements MoralisDataObject {
     ...
     *```
     */
    static create(data: Erc20Mint | Erc20MintInput, core?: _moralisweb3_common_core__default): Erc20Mint;
    private _data;
    constructor(data: Erc20MintInput, core: _moralisweb3_common_core__default);
    static parse: (data: Erc20MintInput, core: _moralisweb3_common_core__default) => Erc20MintData;
    /**
...
declare class Erc20Transfer implements MoralisDataObject {
     ...
     *```
     */
    static create(data: Erc20Transferish, core?: _moralisweb3_common_core__default): Erc20Transfer;
    private _data;
    constructor(data: Erc20TransferInput, core: _moralisweb3_common_core__default);
    static parse: (data: Erc20TransferInput, core: _moralisweb3_common_core__default) => Erc20TransferData;
    /**
...
declare class EvmInternalTransaction implements MoralisDataObject {
     ...
     *```
     */
    static create(data: EvmInternalTransactionish, core?: _moralisweb3_common_core__default): EvmInternalTransaction;
    private _data;
    constructor(data: EvmInternalTransactionInput, core: _moralisweb3_common_core__default);
    static parse: (data: EvmInternalTransactionInput, core: _moralisweb3_common_core__default) => EvmInternalTransactionData;
    /**
...
declare class EvmNftMedia implements MoralisDataObject {
     ...
     *```
     */
    static create(data: EvmNftMediaInput, core?: _moralisweb3_common_core__default): EvmNftMedia;
    private _data;
    constructor(data: EvmNftMediaInput, core: _moralisweb3_common_core__default);
    static parse: (data: EvmNftMediaInput, core: _moralisweb3_common_core__default) => EvmNftMediaData;
    /**
...
declare class EvmTransactionLogDecoded extends EvmTransactionLog {
     ...
     * @param core - The Core instance
     */
    static create(value: EvmTransactionLogDecodedish, core?: _moralisweb3_common_core__default): EvmTransactionLogDecoded;
    protected _value: EvmTransactionLogDecodedData;
    constructor(value: EvmTransactionLogDecodedInput, core: _moralisweb3_common_core__default);
    static parse(value: EvmTransactionLogDecodedInput, core: _moralisweb3_common_core__default): EvmTransactionLogDecodedData;
...
declare class EvmTransactionVerbose extends EvmTransaction {
     ...
     *```
     */
    static create(data: EvmTransactionVerboseish, core?: _moralisweb3_common_core__default): EvmTransactionVerbose;
    constructor(data: EvmTransactionVerboseInput, core: _moralisweb3_common_core__default);
    protected _data: EvmTransactionVerboseData;
    static parse: (data: EvmTransactionVerboseInput, core: _moralisweb3_common_core__default) => EvmTransactionVerboseData;
...
declare function deserializeResponse$z(jsonResponse: GetNFTLowestPriceJSONResponse, request: GetNFTLowestPriceRequest, core: Core): EvmNftTrade;
...
declare function deserializeResponse$v(jsonResponse: GetNFTTradesJSONResponse, request: GetNFTTradesRequest, core: Core): EvmNftTrade[];
...
type OperationId$l = 'resolveAddress';
type PathParams$d = operations$1[OperationId$l]['parameters']['path'];
type RequestParams$j = PathParams$d;
type SuccessResponse$l = operations$1[OperationId$l]['responses']['200']['content']['application/json'];
interface ResolveAddressRequest extends Camelize<Omit<RequestParams$j, 'address'>> {
    address?: EvmAddressish;
}
type ResolveAddressJSONRequest = ReturnType<typeof serializeRequest$j>;
type ResolveAddressJSONResponse = SuccessResponse$l;
type ResolveAddressResponse = ReturnType<typeof deserializeResponse$l>;
...
declare function deserializeResponse$l(jsonResponse: ResolveAddressJSONResponse): {
    name: string;
};
declare function serializeRequest$j(request: ResolveAddressRequest, core: Core): {
    address: string | undefined;
};

type OperationId$k = 'resolveDomain';
type PathParams$c = operations$1[OperationId$k]['parameters']['path'];
type QueryParams$h = operations$1[OperationId$k]['parameters']['query'];
type RequestParams$i = PathParams$c & QueryParams$h;
type SuccessResponse$k = operations$1[OperationId$k]['responses']['200']['content']['application/json'];
interface ResolveDomainRequest extends Camelize<RequestParams$i> {
}
type ResolveDomainJSONRequest = ReturnType<typeof serializeRequest$i>;
type ResolveDomainJSONResponse = SuccessResponse$k;
type ResolveDomainResponse = ReturnType<typeof deserializeResponse$k>;
...
declare function serializeRequest$i(request: ResolveDomainRequest): {
    currency: "eth" | "0x1" | undefined;
    domain: string;
};
declare function deserializeResponse$k(jsonResponse: ResolveDomainJSONResponse, request: ResolveDomainRequest, core: _moralisweb3_common_core__default): {
    address: EvmAddress;
};

type OperationId$j = 'resolveENSDomain';
type PathParams$b = operations$1[OperationId$j]['parameters']['path'];
type RequestParams$h = PathParams$b;
type SuccessResponse$j = operations$1[OperationId$j]['responses']['200']['content']['application/json'];
interface ResolveENSDomainRequest extends Camelize<RequestParams$h> {
}
type ResolveENSDomainJSONRequest = ReturnType<typeof serializeRequest$h>;
type ResolveENSDomainJSONResponse = SuccessResponse$j;
type ResolveENSDomainResponse = ReturnType<typeof deserializeResponse$j>;
...
declare function serializeRequest$h(request: ResolveENSDomainRequest): {
    domain: string;
};
declare function deserializeResponse$j(jsonResponse: ResolveENSDomainJSONResponse, _: ResolveENSDomainRequest, core: _moralisweb3_common_core__default): {
    address: EvmAddress;
};

type OperationId$i = 'getTransaction';
type PathParams$a = operations$1[OperationId$i]['parameters']['path'];
type QueryParams$g = operations$1[OperationId$i]['parameters']['query'];
type RequestParams$g = PathParams$a & QueryParams$g;
type SuccessResponse$i = operations$1[OperationId$i]['responses']['200']['content']['application/json'];
interface GetTransactionRequest extends Camelize<Omit<RequestParams$g, 'chain'>> {
    chain?: EvmChainish;
}
type GetTransactionJSONRequest = ReturnType<typeof serializeRequest$g>;
type GetTransactionJSONResponse = SuccessResponse$i;
type GetTransactionResponse = ReturnType<typeof deserializeResponse$i>;
...
declare function serializeRequest$g(request: GetTransactionRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    transactionHash: string;
    include: "internal_transactions" | undefined;
};
declare function deserializeResponse$i(jsonResponse: GetTransactionJSONResponse, request: GetTransactionJSONRequest, core: Core): EvmTransaction;

type OperationId$h = 'getTransactionVerbose';
type PathParams$9 = operations$1[OperationId$h]['parameters']['path'];
type QueryParams$f = operations$1[OperationId$h]['parameters']['query'];
type RequestParams$f = PathParams$9 & QueryParams$f;
type SuccessResponse$h = components['schemas']['blockTransactionVerbose'];
interface GetTransactionVerboseRequest extends Camelize<Omit<RequestParams$f, 'chain'>> {
    chain?: EvmChainish;
}
type GetTransactionVerboseJSONRequest = ReturnType<typeof serializeRequest$f>;
type GetTransactionVerboseJSONResponse = SuccessResponse$h;
type GetTransactionVerboseResponse = ReturnType<typeof deserializeResponse$h>;
...
declare function serializeRequest$f(request: GetTransactionVerboseRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    transactionHash: string;
};
declare function deserializeResponse$h(jsonResponse: GetTransactionVerboseJSONResponse, request: GetTransactionVerboseJSONRequest, core: Core): EvmTransactionVerbose;

type OperationId$g = 'getWalletTransactions';
type PathParams$8 = operations$1[OperationId$g]['parameters']['path'];
type QueryParams$e = operations$1[OperationId$g]['parameters']['query'];
type RequestParams$e = PathParams$8 & QueryParams$e;
type SuccessResponse$g = operations$1[OperationId$g]['responses']['200']['content']['application/json'];
interface GetWalletTransactionsRequest extends Camelize<Omit<RequestParams$e, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetWalletTransactionsJSONRequest = ReturnType<typeof serializeRequest$e>;
type GetWalletTransactionsJSONResponse = SuccessResponse$g;
type GetWalletTransactionsResponse = ReturnType<typeof deserializeResponse$g>;
...
declare function serializeRequest$e(request: GetWalletTransactionsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: number | undefined;
    fromDate: DateInput | undefined;
...
declare function deserializeResponse$g(jsonResponse: GetWalletTransactionsJSONResponse, request: GetWalletTransactionsJSONRequest, core: Core): EvmTransaction[];

type OperationId$f = 'getWalletTransactionsVerbose';
type PathParams$7 = operations$1[OperationId$f]['parameters']['path'];
type QueryParams$d = operations$1[OperationId$f]['parameters']['query'];
type RequestParams$d = PathParams$7 & QueryParams$d;
type SuccessResponse$f = operations$1[OperationId$f]['responses']['200']['content']['application/json'];
interface GetWalletTransactionsVerboseRequest extends Camelize<Omit<RequestParams$d, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetWalletTransactionsVerboseJSONRequest = ReturnType<typeof serializeRequest$d>;
type GetWalletTransactionsVerboseJSONResponse = SuccessResponse$f;
type GetWalletTransactionsVerboseResponse = ReturnType<typeof deserializeResponse$f>;
...
declare function serializeRequest$d(request: GetWalletTransactionsVerboseRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: number | undefined;
    fromDate: DateInput | undefined;
...
declare function deserializeResponse$f(jsonResponse: GetWalletTransactionsVerboseJSONResponse, request: GetWalletTransactionsVerboseJSONRequest, core: Core): EvmTransaction[];

type OperationId$e = 'getInternalTransactions';
type PathParams$6 = operations$1[OperationId$e]['parameters']['path'];
type QueryParams$c = operations$1[OperationId$e]['parameters']['query'];
type RequestParams$c = PathParams$6 & QueryParams$c;
type SuccessResponse$e = operations$1[OperationId$e]['responses']['200']['content']['application/json'];
interface GetInternalTransactionsRequest extends Camelize<Omit<RequestParams$c, 'chain'>> {
    chain?: EvmChainish;
}
type GetInternalTransactionsJSONRequest = ReturnType<typeof serializeRequest$c>;
type GetInternalTransactionsJSONResponse = SuccessResponse$e;
type GetInternalTransactionsResponse = ReturnType<typeof deserializeResponse$e>;
...
declare function serializeRequest$c(request: GetInternalTransactionsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    transactionHash: string;
};
declare function deserializeResponse$e(jsonResponse: GetInternalTransactionsJSONResponse, request: GetInternalTransactionsJSONRequest, core: Core): EvmInternalTransaction[];

type OperationId$d = 'getErc20Approvals';
type QueryParams$b = operations$1[OperationId$d]['parameters']['query'];
type RequestParams$b = QueryParams$b;
type SuccessResponse$d = operations$1[OperationId$d]['responses']['200']['content']['application/json'];
interface GetErc20ApprovalsRequest extends Camelize<Omit<RequestParams$b, 'chain' | 'contract_addresses' | 'exclude_contracts' | 'wallet_addresses' | 'exclude_wallets'>> {
    chain?: EvmChainish;
...
type GetErc20ApprovalsJSONRequest = ReturnType<typeof serializeRequest$b>;
type GetErc20ApprovalsJSONResponse = SuccessResponse$d;
type GetErc20ApprovalsResponse = ReturnType<typeof deserializeResponse$d>;
...
declare function deserializeResponse$d(jsonResponse: GetErc20ApprovalsJSONResponse, request: GetErc20ApprovalsRequest, core: Core): Erc20Approval[];
declare function serializeRequest$b(request: GetErc20ApprovalsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    fromBlock: number | undefined;
...
type OperationId$c = 'getErc20Burns';
...
interface GetErc20BurnsRequest extends Camelize<Omit<RequestParams$a, 'chain' | 'contract_addresses' | 'exclude_contracts' | 'wallet_addresses' | 'exclude_wallets'>> {
    chain?: EvmChainish;
    contractAddresses?: EvmAddressish[];
    excludeContracts?: EvmAddressish[];
    walletAddresses?: EvmAddressish[];
...
type GetErc20BurnsJSONRequest = ReturnType<typeof serializeRequest$a>;
type GetErc20BurnsJSONResponse = SuccessResponse$c;
type GetErc20BurnsResponse = ReturnType<typeof deserializeResponse$c>;
...
declare function deserializeResponse$c(jsonResponse: GetErc20BurnsJSONResponse, request: GetErc20BurnsRequest, core: Core): Erc20Burn[];
declare function serializeRequest$a(request: GetErc20BurnsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    fromBlock: number | undefined;
...
type OperationId$b = 'getErc20Transfers';
type QueryParams$9 = operations$1[OperationId$b]['parameters']['query'];
type RequestParams$9 = QueryParams$9;
type SuccessResponse$b = operations$1[OperationId$b]['responses']['200']['content']['application/json'];
interface GetErc20TransfersRequest extends Camelize<Omit<RequestParams$9, 'chain' | 'contract_addresses' | 'exclude_contracts' | 'wallet_addresses' | 'exclude_wallets'>> {
    chain?: EvmChainish;
    contractAddresses?: EvmAddressish[];
    excludeContracts?: EvmAddressish[];
    walletAddresses?: EvmAddressish[];
...
type GetErc20TransfersJSONRequest = ReturnType<typeof serializeRequest$9>;
type GetErc20TransfersJSONResponse = SuccessResponse$b;
type GetErc20TransfersResponse = ReturnType<typeof deserializeResponse$b>;
...
declare function deserializeResponse$b(jsonResponse: GetErc20TransfersJSONResponse, request: GetErc20TransfersRequest, core: Core): Erc20Transfer[];
declare function serializeRequest$9(request: GetErc20TransfersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    fromBlock: number | undefined;
...
type OperationId$a = 'getErc20Mints';
type QueryParams$8 = operations$1[OperationId$a]['parameters']['query'];
type RequestParams$8 = QueryParams$8;
type SuccessResponse$a = operations$1[OperationId$a]['responses']['200']['content']['application/json'];
interface GetErc20MintsRequest extends Camelize<Omit<RequestParams$8, 'chain' | 'contract_addresses' | 'exclude_contracts' | 'wallet_addresses' | 'exclude_wallets'>> {
    chain?: EvmChainish;
    contractAddresses?: EvmAddressish[];
    excludeContracts?: EvmAddressish[];
    walletAddresses?: EvmAddressish[];
...
type GetErc20MintsJSONRequest = ReturnType<typeof serializeRequest$8>;
type GetErc20MintsJSONResponse = SuccessResponse$a;
type GetErc20MintsResponse = ReturnType<typeof deserializeResponse$a>;
...
declare function deserializeResponse$a(jsonResponse: GetErc20MintsJSONResponse, request: GetErc20MintsRequest, core: Core): Erc20Mint[];
declare function serializeRequest$8(request: GetErc20MintsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    fromBlock: number | undefined;
...
type OperationId$8 = 'getTokenMetadataBySymbol';
...
interface GetTokenMetadataBySymbolRequest extends Camelize<Omit<RequestParams$6, 'chain'>> {
    chain?: EvmChainish;
}
type GetTokenMetadataBySymbolJSONRequest = ReturnType<typeof serializeRequest$6>;
type GetTokenMetadataBySymbolJSONResponse = SuccessResponse$8;
type GetTokenMetadataBySymbolResponse = ReturnType<typeof deserializeResponse$8>;
...
declare function deserializeResponse$8(jsonResponse: GetTokenMetadataBySymbolJSONResponse, request: GetTokenMetadataBySymbolRequest, core: Core): {
    token: Erc20Token;
    blockNumber: string | undefined;
    validated: string | undefined;
}[];
declare function serializeRequest$6(request: GetTokenMetadataBySymbolRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    symbols: string[];
};

type OperationId$7 = 'getTokenMetadata';
...
interface GetTokenMetadataRequest extends Camelize<Omit<RequestParams$5, 'chain' | 'addresses'>> {
    chain?: EvmChainish;
    addresses: EvmAddressish[];
}
type GetTokenMetadataJSONRequest = ReturnType<typeof serializeRequest$5>;
type GetTokenMetadataJSONResponse = SuccessResponse$7;
type GetTokenMetadataResponse = ReturnType<typeof deserializeResponse$7>;
...
declare function deserializeResponse$7(jsonResponse: GetTokenMetadataJSONResponse, request: GetTokenMetadataRequest, core: Core): {
    token: Erc20Token;
    blockNumber: string | undefined;
    validated: string | undefined;
}[];
declare function serializeRequest$5(request: GetTokenMetadataRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    addresses: string[];
};
