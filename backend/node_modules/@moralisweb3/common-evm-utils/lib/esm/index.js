...
var Erc20Burn = /** @class */ (function () {
    ...
    Erc20Burn.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), contractAddress: EvmAddress.create(data.contractAddress, core), fromWallet: EvmAddress.create(data.fromWallet, core), blockTimestamp: dateInputToDate(data.blockTimestamp), blockNumber: BigNumber.create(data.blockNumber), value: BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
    return Erc20Burn;
}());
...
var Erc20Mint = /** @class */ (function () {
    ...
    Erc20Mint.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), contractAddress: EvmAddress.create(data.contractAddress, core), toWallet: EvmAddress.create(data.toWallet, core), blockTimestamp: dateInputToDate(data.blockTimestamp), blockNumber: BigNumber.create(data.blockNumber), value: BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
    return Erc20Mint;
}());
...
var Erc20Transfer = /** @class */ (function () {
    ...
    Erc20Transfer.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), address: EvmAddress.create(data.address, core), blockTimestamp: dateInputToDate(data.blockTimestamp), blockNumber: BigNumber.create(data.blockNumber), toAddress: EvmAddress.create(data.toAddress, core), fromAddress: EvmAddress.create(data.fromAddress, core), value: BigNumber.create(data.value), transactionIndex: Number(data.transactionIndex), logIndex: Number(data.logIndex) })); };
...
var EvmNftMedia = /** @class */ (function () {
    ...
    EvmNftMedia.parse = function (data, core) { return (__assign(__assign({}, data), { chain: EvmChain.create(data.chain, core), updatedAt: maybe(data.updatedAt, function (date) { return dateInputToDate(date); }) })); };
    return EvmNftMedia;
}());
...
function deserializeResponse$x(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (data) {
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = toCamelCase(data);
        return EvmNft.create(__assign(__assign({}, nft), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.ownerOf, core), lastMetadataSync: new Date(nft.lastMetadataSync), lastTokenUriSync: new Date(nft.lastTokenUriSync), media: maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$w(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (data) {
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = toCamelCase(data);
        return EvmNft.create(__assign(__assign({}, toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.ownerOf, core), lastMetadataSync: new Date(nft.lastMetadataSync), lastTokenUriSync: new Date(nft.lastTokenUriSync), media: maybe(nft.media, function (media) {
                return EvmNftMedia.create(__assign({ chain: chain }, toCamelCase(media)), core);
            }) }), core);
    });
}
...
function deserializeResponse$i(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (approval) {
        return Erc20Approval.create(__assign(__assign({}, toCamelCase(approval)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$i(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$h(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (burn) {
        return Erc20Burn.create(__assign(__assign({}, toCamelCase(burn)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$h(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$g(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (transfer) {
        return Erc20Transfer.create(__assign(__assign({}, toCamelCase(transfer)), { chain: EvmChainResolver.resolve(request.chain, core), address: EvmAddress.create(transfer.contract_address, core), toAddress: EvmAddress.create(transfer.to_wallet, core), fromAddress: EvmAddress.create(transfer.from_wallet, core) }), core);
    });
}
function serializeRequest$g(request, core) {
    var _a, _b, _c, _d;
...
function deserializeResponse$f(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (mint) {
        return Erc20Mint.create(__assign(__assign({}, toCamelCase(mint)), { chain: EvmChainResolver.resolve(request.chain, core) }), core);
    });
}
function serializeRequest$f(request, core) {
    var _a, _b, _c, _d;
