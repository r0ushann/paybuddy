...
var StreamTrigger = /** @class */ (function () {
    ...
    StreamTrigger.parseSelectorOrAddress = function (input, core) {
        ...
        if (!(input instanceof commonEvmUtils.EvmAddress) && StreamSelector.isSelectorString(input)) {
            ...
            result = commonEvmUtils.EvmAddress.create(input, core);
        }
        return result;
    };
    ...
    StreamTrigger.parse = function (data, core) {
        ...
        var callFrom = commonCore.maybe(callFromInput, function (value) { return StreamTrigger.parseSelectorOrAddress(value, core); });
...
var EvmStream = /** @class */ (function () {
    ...
    EvmStream.parse = function (data, core) {
        var _a, _b, _c, _d, _e;
        return __assign(__assign({}, data), { chains: data.chainIds.map(function (chainId) { return commonEvmUtils.EvmChain.create(chainId, core); }), topic0: commonCore.maybe(data.topic0), allAddresses: (_a = data.allAddresses) !== null && _a !== void 0 ? _a : false, includeContractLogs: (_b = data.includeContractLogs) !== null && _b !== void 0 ? _b : false, includeInternalTxs: (_c = data.includeInternalTxs) !== null && _c !== void 0 ? _c : false, includeAllTxLogs: (_d = data.includeAllTxLogs) !== null && _d !== void 0 ? _d : false, includeNativeTxs: (_e = data.includeNativeTxs) !== null && _e !== void 0 ? _e : false, advancedOptions: commonCore.maybe(data.advancedOptions), abi: commonCore.maybe(data.abi), triggers: commonCore.maybe(data.triggers, function (triggers) { return triggers.map(function (trigger) { return StreamTrigger.create(trigger, core); }); }), getNativeBalances: commonCore.maybe(data.getNativeBalances) });
    };
    return EvmStream;
}());
...
var StreamErc1155Approval = /** @class */ (function () {
    ...
    StreamErc1155Approval.prototype.toJSON = function () {
        var _a;
        var data = this._data;
        return __assign(__assign({}, data), { chain: data.chain.format(), contract: data.contract.format(), account: data.account.format(), operator: data.operator.format(), triggers: (_a = data.triggers) === null || _a === void 0 ? void 0 : _a.map(function (trigger) { return trigger.format(); }) });
    };
    /**
     * Converts the StreamErc1155Approval instance to a JSON object.
     * @returns JSON object of the StreamErc1155Approval instance
    ...
    StreamErc1155Approval.parse = function (data, core) {
        var chain = commonEvmUtils.EvmChain.create(data.chain, core);
        return __assign(__assign({}, data), { chain: chain, logIndex: +data.logIndex, account: commonEvmUtils.EvmAddress.create(data.account, core), operator: commonEvmUtils.EvmAddress.create(data.operator, core), contract: commonEvmUtils.EvmAddress.create(data.contract, core), tokenContractType: data.tokenContractType, triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
...
var StreamErc20Approval = /** @class */ (function () {
    ...
    StreamErc20Approval.parse = function (data, core) {
        var chain = commonEvmUtils.EvmChain.create(data.chain, core);
        return __assign(__assign({}, data), { chain: chain, spender: commonEvmUtils.EvmAddress.create(data.spender, core), owner: commonEvmUtils.EvmAddress.create(data.owner, core), logIndex: +data.logIndex, contract: commonEvmUtils.EvmAddress.create(data.contract, core), value: commonCore.BigNumber.create(data.value), valueWithDecimals: commonCore.maybe(data.valueWithDecimals), tokenDecimals: data.tokenDecimals === '' ? undefined : +data.tokenDecimals, triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
...
var StreamErc20Transfer = /** @class */ (function () {
    ...
    StreamErc20Transfer.prototype.toJSON = function () {
        ...
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        return __assign(__assign({}, data), { chain: chain.format(), from: from.format(), to: to.format(), contract: contract.format(), value: value.toString(), triggers: triggers === null || triggers === void 0 ? void 0 : triggers.map(function (trigger) { return trigger.format(); }) });
    };
    /**
     * Converts the StreamErc20Transfer instance to a JSON object.
     * @returns JSON object of the StreamErc20Transfer instance
    ...
    StreamErc20Transfer.parse = function (data, core) {
        var chain = commonEvmUtils.EvmChain.create(data.chain, core);
        return __assign(__assign({}, data), { chain: chain, from: commonEvmUtils.EvmAddress.create(data.from, core), to: commonEvmUtils.EvmAddress.create(data.to, core), logIndex: +data.logIndex, contract: commonEvmUtils.EvmAddress.create(data.contract, core), value: commonCore.BigNumber.create(data.value), valueWithDecimals: commonCore.maybe(data.valueWithDecimals), tokenDecimals: data.tokenDecimals === '' ? undefined : +data.tokenDecimals, triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
...
var StreamErc721Approval = /** @class */ (function () {
    ...
    StreamErc721Approval.parse = function (data, core) {
        var chain = commonEvmUtils.EvmChain.create(data.chain, core);
        return __assign(__assign({}, data), { chain: chain, logIndex: +data.logIndex, owner: commonEvmUtils.EvmAddress.create(data.owner, core), contract: commonEvmUtils.EvmAddress.create(data.contract, core), tokenContractType: data.tokenContractType, approved: commonEvmUtils.EvmAddress.create(data.approved, core), triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
...
var StreamEvmInternalTransaction = /** @class */ (function () {
    ...
    StreamEvmInternalTransaction.parse = function (data, core) { return (__assign(__assign({}, data), { chain: commonEvmUtils.EvmChain.create(data.chain, core), from: commonCore.maybe(data.from, function (value) { return commonEvmUtils.EvmAddress.create(value, core); }), to: commonCore.maybe(data.to, function (value) { return commonEvmUtils.EvmAddress.create(value, core); }), value: commonCore.maybe(data.value, function (value) { return commonCore.BigNumber.create(value); }), gas: commonCore.maybe(data.gas, function (value) { return commonCore.BigNumber.create(value); }), triggers: commonCore.maybe(data.triggers, function (triggers) { return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); }); }) })); };
...
var StreamEvmNftTransfer = /** @class */ (function () {
    ...
    StreamEvmNftTransfer.parse = function (data, core) {
        return __assign(__assign({}, data), { chain: commonEvmUtils.EvmChain.create(data.chain, core), to: commonEvmUtils.EvmAddress.create(data.to, core), contract: commonEvmUtils.EvmAddress.create(data.contract, core), from: commonEvmUtils.EvmAddress.create(data.from, core), logIndex: +data.logIndex, operator: commonCore.maybe(data.operator, function (operator) { return commonEvmUtils.EvmAddress.create(operator, core); }), tokenId: data.tokenId, transactionHash: data.transactionHash, amount: +data.amount, tokenName: data.tokenName, triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
    /**
...
var StreamEvmTransactionLog = /** @class */ (function () {
    ...
    StreamEvmTransactionLog.parse = function (data, core) {
        return __assign(__assign({}, data), { chain: commonEvmUtils.EvmChain.create(data.chain, core), logIndex: +data.logIndex, address: commonEvmUtils.EvmAddress.create(data.address, core), topic0: commonCore.maybe(data.topic0), topic1: commonCore.maybe(data.topic1), topic2: commonCore.maybe(data.topic2), topic3: commonCore.maybe(data.topic3), triggers: commonCore.maybe(data.triggers, function (triggers) {
                return triggers.map(function (trigger) { return StreamTriggerOutput.create(trigger, core); });
            }) });
    };
    /**
...
var StreamNativeBalance = /** @class */ (function () {
    ...
    StreamNativeBalance.parse = function (input, core) {
        return {
            address: commonEvmUtils.EvmAddress.create(input.address, core),
...
var EvmStreamResultParser = /** @class */ (function () {
    ...
    EvmStreamResultParser.parseChainId = function (value, core) {
        ...
        return value === '' ? commonEvmUtils.EvmChain.ETHEREUM : commonEvmUtils.EvmChain.create(value, core);
    };
...
var EvmStreamResult = /** @class */ (function () {
    ...
    EvmStreamResult.parse = function (data, core) {
        return EvmStreamResultParser.parse(data, core);
    };
...
function getRequestBody$7(request, core) {
    return {
        address: Array.isArray(request.address)
            ? request.address.map(function (a) { return commonEvmUtils.EvmAddress.create(a, core).checksum; })
            : commonEvmUtils.EvmAddress.create(request.address, core).checksum,
    };
}
...
function deserializeRequest$f(jsonRequest, core) {
    return {
        id: jsonRequest.id,
        address: Array.isArray(jsonRequest.address)
            ? jsonRequest.address.map(function (a) { return commonEvmUtils.EvmAddress.create(a, core); })
            : commonEvmUtils.EvmAddress.create(jsonRequest.address, core),
    };
}
...
function deserializeResponse$e(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (stream) { return EvmStream.create(stream, core); });
}
...
function getRequestBody$6(request, core) {
    ...
    return {
        ...
        chainIds: request.chains.map(function (chain) { return commonEvmUtils.EvmChain.create(chain, core).apiHex; }),
        abi: request.abi,
        advancedOptions: request.advancedOptions,
        demo: request.demo,
        triggers: (_a = request.triggers) === null || _a === void 0 ? void 0 : _a.map(function (trigger) { return StreamTrigger.create(trigger, core).format(); }),
    };
}
...
function deserializeRequest$c(jsonRequest, core) {
    ...
    return {
        ...
        chains: jsonRequest.chainIds.map(function (chainId) { return commonEvmUtils.EvmChain.create(chainId, core); }),
        abi: jsonRequest.abi,
        advancedOptions: jsonRequest.advancedOptions,
        demo: jsonRequest.demo,
        triggers: (_a = jsonRequest.triggers) === null || _a === void 0 ? void 0 : _a.map(function (trigger) { return StreamTrigger.create(trigger, core); }),
    };
}
...
function deserializeResponse$b(jsonResponse, request, core) {
    ...
    return {
        ...
        address: data.address
            ? typeof data.address === 'string'
                ? commonEvmUtils.EvmAddress.create(data.address, core)
                : data.address.map(function (address) { return commonEvmUtils.EvmAddress.create(address, core); })
            : undefined,
    };
}
function serializeRequest$b(request, core) {
    return {
        id: request.id,
        address: Array.isArray(request.address)
            ? request.address.map(function (address) { return commonEvmUtils.EvmAddress.create(address, core).lowercase; })
            : commonEvmUtils.EvmAddress.create(request.address, core).lowercase,
    };
}
function deserializeRequest$b(jsonRequest, core) {
    return {
        id: jsonRequest.id,
        address: Array.isArray(jsonRequest.address)
            ? jsonRequest.address.map(function (address) { return commonEvmUtils.EvmAddress.create(address, core); })
            : commonEvmUtils.EvmAddress.create(jsonRequest.address, core),
    };
}
...
function deserializeResponse$9(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (stream) { return (__assign(__assign({}, stream), { address: stream.address ? commonEvmUtils.EvmAddress.create(stream.address, core) : undefined })); });
}
...
function getRequestBody$3(request, core) {
    var _a, _b;
    return {
        webhookUrl: request.webhookUrl,
        description: request.description,
        ...
        includeAllTxLogs: request.includeAllTxLogs,
        getNativeBalances: request.getNativeBalances,
        chainIds: (_a = request.chains) === null || _a === void 0 ? void 0 : _a.map(function (chain) { return commonEvmUtils.EvmChain.create(chain, core).apiHex; }),
        abi: request.abi,
        advancedOptions: request.advancedOptions,
        demo: request.demo,
        triggers: (_b = request.triggers) === null || _b === void 0 ? void 0 : _b.map(function (trigger) { return StreamTrigger.create(trigger, core); }),
    };
}
...
function serializeRequest$8(request, core) {
    ...
    return {
        ...
        advancedOptions: request.advancedOptions,
        demo: request.demo,
        triggers: (_b = request.triggers) === null || _b === void 0 ? void 0 : _b.map(function (trigger) { return StreamTrigger.create(trigger, core).format(); }),
    };
}
function deserializeRequest$8(jsonRequest, core) {
    ...
    return {
        ...
        includeInternalTxs: jsonRequest.includeInternalTxs,
        includeAllTxLogs: jsonRequest.includeAllTxLogs,
        chains: (_a = jsonRequest.chainIds) === null || _a === void 0 ? void 0 : _a.map(function (chainId) { return commonEvmUtils.EvmChain.create(chainId, core); }),
        abi: jsonRequest.abi,
        advancedOptions: jsonRequest.advancedOptions,
        demo: jsonRequest.demo,
        triggers: (_b = jsonRequest.triggers) === null || _b === void 0 ? void 0 : _b.map(function (trigger) { return StreamTrigger.create(trigger, core); }),
    };
}
