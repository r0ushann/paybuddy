...
import Core, { MoralisDataObject, MoralisData, BigNumberish, BigNumber, Camelize, ResponseAdapter, Operation, PaginatedResponseAdapter, PaginatedOperation, Core as Core$1 } from '@moralisweb3/common-core';
...
declare class StreamErc721Approval implements MoralisDataObject {
     ...
     */
    static create(data: StreamErc721Approvalish, core?: Core): StreamErc721Approval;
    private _data;
...
declare function serializeRequest$d(request: AddAddressEvmRequest, core: Core$1): {
    id: string;
    address: string | string[];
};
...
declare function deserializeResponse$e(jsonResponse: GetStreamsEvmJSONResponse, request: GetStreamsEvmRequest, core: Core$1): EvmStream[];
...
declare function deserializeResponse$d(jsonResponse: GetStreamEvmJSONResponse, request: GetStreamEvmRequest, core: Core$1): EvmStream;
...
declare function deserializeResponse$c(jsonResponse: CreateStreamEvmJSONResponse, request: CreateStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$a(request: CreateStreamEvmRequest, core: Core$1): {
    webhookUrl: string;
    description: string;
    tag: string;
...
declare function deserializeResponse$b(jsonResponse: DeleteAddressEvmJSONResponse, request: DeleteAddressEvmRequest, core: Core$1): {
    streamId: string;
    address: EvmAddress | EvmAddress[] | undefined;
};
declare function serializeRequest$9(request: DeleteAddressEvmRequest, core: Core$1): {
    id: string;
    address: string | string[];
};
...
declare function deserializeResponse$a(jsonResponse: DeleteStreamEvmJSONResponse, request: DeleteStreamEvmRequest, core: Core$1): EvmStream;
...
declare function deserializeResponse$9(jsonResponse: GetAddressesEvmJSONResponse, request: GetAddressesEvmRequest, core: Core$1): {
...
declare function deserializeResponse$8(jsonResponse: UpdateStreamEvmJSONResponse, request: UpdateStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$6(request: UpdateStreamEvmRequest, core: Core$1): {
    id: string;
    webhookUrl: string | undefined;
    description: string | undefined;
    tag: string | undefined;
