    ...
    function ClientEvmApi() {
        ...
        _this.utils = {
            endpointWeights: function () {
                return new apiUtils.OperationResolver(commonEvmUtils.endpointWeightsOperation, _this.baseUrl, _this.core).fetch({});
            },
            ...
            web3ApiVersion: function () {
                return new apiUtils.OperationResolver(commonEvmUtils.web3ApiVersionOperation, _this.baseUrl, _this.core).fetch({});
            },
        };
        _this.block = {
        ...
        _this.nft = {
            ...
            getNFTTrades: function (request) {
                return new apiUtils.PaginatedOperationResolver(commonEvmUtils.getNFTTradesOperation, _this.baseUrl, _this.core).fetch(request);
            },
